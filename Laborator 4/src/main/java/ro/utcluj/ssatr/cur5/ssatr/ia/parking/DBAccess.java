...
public class DBAccess {
    ...
    public DBAccess() throws ClassNotFoundException, SQLException {
         ...
         conn = DriverManager.getConnection("jdbc:derby://localhost:1527/test_db4;create=false","APP","APP");
    }
    
    public void insertCarHistory(CarAccessEntity e) throws SQLException{
        Statement s = conn.createStatement();
        s.executeUpdate("INSERT INTO CARACCESSHISTORY VALUES ('"+e.getPlateNumber()+"',"+e.getEntryTime()+")");        
        s.close();
    }
